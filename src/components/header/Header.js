...
const Header = ({ currentLocale }) => {
  ...
  return (
    <>
      ...
      <header
        ref={headerRef}
        style={{ background: "#e8a355", color: "white" }}
                        ...
                        >
                          ...
                          >
                            <div className="flex items-center justify-between">
                              ...
                              {subItem.showCount && favoritesCount > 0 && (
                                <span className="bg-[#295557] text-white rounded-full w-5 h-5 text-xs flex items-center justify-center font-bold">
                                  {favoritesCount}
                                </span>
                              )}
                            </div>
                            ...
                            >
                              {subItem.subMenu.map((subSubItem) => (
                                <li key={`${subItem.id}-${subSubItem.id}`}>
                                  {" "}
                                  {/* Ensure uniqueness for nested subMenus */}
                                  <Link
