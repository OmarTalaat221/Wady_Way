          ...
          <div className="swiper-wrapper">
            ...
            <SwiperSlide className="swiper-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, rgba(16, 12, 8, 0.6) 0%, rgba(16, 12, 8, 0.6) 100%), url(assets/img/home3/2.jpg)",
                }}
              >
                <div className="home3-banner-content-wrap">
                  <div className="container">
            ...
            <SwiperSlide className="swiper-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, rgba(16, 12, 8, 0.6) 0%, rgba(16, 12, 8, 0.6) 100%), url(assets/img/home3/3.jpg)",
                }}
              >
                <div className="home3-banner-content-wrap">
                  <div className="container">
            ...
            <SwiperSlide className="swiper-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, rgba(16, 12, 8, 0.6) 0%, rgba(16, 12, 8, 0.6) 100%), url(assets/img/home3/4.jpg)",
                }}
              >
                <div className="home3-banner-content-wrap">
                  <div className="container">
