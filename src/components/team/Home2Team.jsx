                  ...
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <div className="teams-card">
                        <img src="https://travelami.templaza.net/wp-content/uploads/2024/03/damiano-baschiera-hFXZ5cNfkOk-unsplash.jpg" alt="" />
                        <div className="teams-img">
                          <img
                          // style={{height:"416px" , width:"312px"}}
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="teams-card">
                        <img src="https://travelami.templaza.net/wp-content/uploads/2024/03/anthony-delanoix-Q0-fOL2nqZc-unsplash.jpg" alt="" />
                        <div className="teams-img">
                          <img
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="teams-card">
                        <img src="https://travelami.templaza.net/wp-content/uploads/2024/03/giuseppe-mondi-OIbcmFyMDbo-unsplash.jpg" alt="" />
                        <div className="teams-img">
                          <img
                            src="https://travelami.templaza.net/wp-content/uploads/2025/02/Our-Team-1-700x831.jpg"
                            alt=""
                          />
                        </div>
                        <div className="teams-content">
