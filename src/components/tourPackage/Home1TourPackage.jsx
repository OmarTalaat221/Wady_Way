              ...
              <div className="package-card">
                <div className="package-card-img-wrap">
                  <Link href="/package/package-details" className="card-img">
                    <img
                      src="https://travelami.templaza.net/wp-content/uploads/2024/03/blog2-300x196.jpg"
                      alt=""
                    />
                  </Link>
                  <div className="batch">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="package-card">
                <div className="package-card-img-wrap">
                  <Link href="/package/package-details" className="card-img">
                    <img
                      src="https://travelami.templaza.net/wp-content/uploads/2024/03/pascal-debrunner-1WQ5RZuH9xo-unsplash1380-300x196.jpg"
                      alt=""
                    />
                  </Link>
                  <div className="batch">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="package-card">
                <div className="package-card-img-wrap">
                  <Link href="/package/package-details" className="card-img">
                    <img
                      src="https://travelami.templaza.net/wp-content/uploads/2024/04/kit-suman-5mcnzeSHFvE-unsplash-500x500.jpg"
                      alt=""
                    />
                  </Link>
                  <div className="batch">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="package-card">
                <div className="package-card-img-wrap">
                  <Link href="/package/package-details" className="card-img">
                    <img
                      src="https://travelami.templaza.net/wp-content/uploads/2024/04/chris-czermak-7ybKmhDTcz0-unsplash-1024x485.jpg"
                      alt=""
                    />
                  </Link>
                  <div className="batch">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="package-card">
                <div className="package-card-img-wrap">
                  <Link href="/package/package-details" className="card-img">
                    <img
                      src="https://travelami.templaza.net/wp-content/uploads/2024/04/fynn-schmidt-IYKL2uhgsnU-unsplash-500x500.jpg"
                      alt=""
                    />
                  </Link>
                  <div className="batch">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="package-card">
                <div className="package-card-img-wrap">
                  <Link href="/package/package-details" className="card-img">
                    <img
                      src="https://travelami.templaza.net/wp-content/uploads/2024/04/caleb-miller-0Bs3et8FYyg-unsplash-e1712501886990-1024x485.jpg"
                      alt=""
                    />
                  </Link>
                  <div className="batch">
