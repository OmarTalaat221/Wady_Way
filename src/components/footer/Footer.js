...
// ─── Reusable SVG Icon Components (memo'd to avoid re-renders) ───
  ...
  <ul className="social-list">
    ...
    <li>
      <a
        ...
        target="_blank"
      >
        <i className="bx bxl-pinterest-alt" aria-hidden="true" />
      </a>
    </li>
    <li>
      <a
...
// ─── Payment Icons (memo'd) ───
const PaymentIcons = memo(() => (
  <div className="icons">
    <ul>
      {["visa", "stripe", "paypal", "woo", "skrill"].map((name) => (
        <li key={name}>
          <Image
            src={`/assets/img/home1/icon/${name}-logo.svg`}
            alt={`${name} payment`}
            width={40}
            height={24}
            loading="lazy"
...
const QuickLinks = memo(() => {
  const links = [
    ...
    { href: "/package-grid", label: "Tour Package" },
    { href: "/guide2", label: "Tour Guide" },
    { href: "/blog-grid", label: "Article" },
  ];
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="footer-widget">
                <div className="footer-logo">
                  <Link href="/" aria-label="Wadi Way Home">
                    <Image
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-md-start">
              <div className="footer-widget">
                ...
                <div className="single-contact">
                  ...
                  <a
                    href="https://www.google.com/maps/place/Egens+Lab/@23.8340712,90.3631117,17z"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
        ...
        <div className="footer-bottom">
          <div className="row">
            <div className="col-lg-12 d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
              <SocialLinks />
              <p>
                ©Copyright 2025 WADI WAY | Design By{" "}
                <a
