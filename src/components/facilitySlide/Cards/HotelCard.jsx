...
export default function HotelCard({ hotel }) {
  ...
  const shareOnWhatsapp = () => {
    const url = `${window.location.origin}${href}`;
    const message = `Check out this hotel: ${title} - ${url}`;
  ...
  return (
    <div className="package-card">
      ...
      <div className="package-card-img-wrap">
        <Link href={href} className="card-img block rounded-xl">
          <img
            src={image}
            alt={title}
        ...
        <div
          className={`favorite-btn ${hotel.is_fav ? "active" : ""} ${
