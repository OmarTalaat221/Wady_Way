          ...
          <div className="row g-4">
            <div className="col-lg-3 col-sm-6">
              <div className="destination-card">
                <img src="https://travelami.templaza.net/wp-content/uploads/2024/04/daniela-cuevas-t7YycgAoVSw-unsplash.jpg" className="h-full" alt="" />
            ...
            <div className="col-lg-5 col-sm-6">
              <div className="destination-card">
                <img src="https://travelami.templaza.net/wp-content/uploads/2024/04/alexander-ramsey-dBtWLliLt5k-unsplash.jpg" alt="" />
                <div className="overlay" />
                <div className="card-title">
                  <h4>Italy</h4>
                </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="destination-card">
                <img src="https://travelami.templaza.net/wp-content/uploads/2024/03/pascal-debrunner-1WQ5RZuH9xo-unsplash1380.jpg" alt="" />
                <div className="overlay" />
                <div className="card-title">
                  <h4>New York</h4>
                </div>
            ...
            <div className="col-lg-5 col-sm-6">
              <div className="destination-card">
                <img src="https://travelami.templaza.net/wp-content/uploads/2024/03/luca-bravo-VowIFDxogG4-unsplash1380.jpg" alt="" />
                <div className="overlay" />
                <div className="card-title">
                  <h4>Saudi Arab</h4>
                </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="destination-card">
                <img src="https://travelami.templaza.net/wp-content/uploads/2024/04/hanson-lu-_8EFj6ISA08-unsplash.jpg" alt="" />
                <div className="overlay" />
                <div className="card-title">
                  <h4>Europe</h4>
                </div>
