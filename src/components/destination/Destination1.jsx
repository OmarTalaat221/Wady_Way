          ...
          <div className="row g-4">
            <div className="col-lg-3 col-sm-6">
              ...
              >
                ...
                <div className="content">
                  <h4>
                    <Link href="/destination/destination-details">Oman</Link>
                  </h4>
            ...
            <div className="col-lg-5 col-sm-6">
              ...
              >
                ...
                <div className="content">
                  <h4>
                    <Link href="/destination/destination-details">Emirate</Link>
                  </h4>
                  <div className="eg-tag">
                    <span>30 Tour</span>
                  </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="destination-card">
                <img
                  src="https://travelami.templaza.net/wp-content/uploads/2024/04/hanson-lu-_8EFj6ISA08-unsplash.jpg"
                  alt=""
                />
                <div className="overlay" />
                <div className="card-title">
