              ...
              <div className="blog-meta two mb-50">
                <div className="author-area">
                  <div className="author-img">
                    <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740912571/ana-nichita-BI91NrppE38-unsplash_cynfsk.jpg" alt="" />
                  </div>
                ...
                <div className="comment-area" id="comment-area">
                  ...
                  <ul className="comment">
                    ...
                    <li>
                      <div className="single-comment-area">
                        <div className="author-img">
                          <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740662904/fabio-comparelli-uq2E2V4LhCY-unsplash_ae15ei.jpg" alt="" />
                        </div>
                        <div className="comment-content">
                          <div className="author-name-deg">
                ...
                <div className="single-widget mb-30">
                  ...
                  <div className="recent-post-widget mb-20">
                    <div className="recent-post-img">
                      <Link href="/blog/blog-details"><img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740914485/jack-ward-rknrvCrfS1k-unsplash_wlpbz5.jpg" alt="" /></Link>
                    </div>
                  ...
                  <div className="recent-post-widget mb-20">
                    <div className="recent-post-img">
                      <Link href="/blog/blog-details"><img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740912235/atik-sulianami-gJegRRpCm1g-unsplash_eh0qfz.jpg" alt="" /></Link>
                    </div>
                    <div className="recent-post-content">
                  ...
                  <div className="recent-post-widget mb-20">
                    <div className="recent-post-img">
                      <Link href="/blog/blog-details"><img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740903193/chris-karidis-nnzkZNYWHaU-unsplash_iqwgll.jpg" alt="" /></Link>
                    </div>
                    <div className="recent-post-content">
