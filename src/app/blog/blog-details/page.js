          ...
          <div className="row g-lg-4 gy-5 justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="post-title mb-10">
                <h1>
                  Our Begin Now Todo Beingon What You Will Be own fully gone.
                </h1>
              </div>
              <div className="blog-meta two mb-50">
                <div className="author-area">
                  <div className="author-img">
                    <img
                      src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740912571/ana-nichita-BI91NrppE38-unsplash_cynfsk.jpg"
                      alt=""
                    />
                  </div>
              ...
              <p className="first-para">
                ...
                Vestibulum antema ypsumi primisot inaetahsjanl faucibus orci
                luctus etenjot ultrices posuere cubilia andt.
              </p>
              <p className="second-para">
                Vestibulum quis odio ut dui malesuada ornare ut id tellus.
                Curabitur viverra at magna ac bibendum. Aliquam erat volutpat.
                Proin rhoncus est ac ipsum varius fermentum. Integer a odio
                ornare mauris pharetra suscipitot. Integer vulputate elit erat.
                Vestibulum quam velit, sagittis et ipsum id, faucibus volutpat
                nibh. Quisque cotten commodo massa eget fringilla facilisis.
                Integer non nisl elit. In ac tempor ante, eget iaculis augue.
                Nuncekon dolor mi, accumsan quis ante id, eleifend suscipit
                purus. Praesent augue eros, consectetur eu eleifend inno, eget
                condimentum auctor, libero ipsum viverra nisi, at vulputate ex
                mi suscipit nunc.{" "}
              </p>
              <blockquote>
              ...
              <p>
                ...
                Proin rhoncus est ac ipsum varius fermentum. Integer a odio
                ornare mauris pharetra suscipitot. Integer vulputate elit erat.
                Vestibulum quam velit, sagittis et ipsum id.{" "}
              </p>
