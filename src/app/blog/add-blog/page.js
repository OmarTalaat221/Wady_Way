...
const AddBlogPage = () => {
  ...
  if (!isLoggedIn) {
    return (
      <>
        <Breadcrumb pagename="Add Blog" pagetitle="Add Blog" />
        <div className="w-full bg-white py-20">
          <div className="max-w-md mx-auto text-center bg-white border-2 border-[#295557] rounded-lg p-8">
            ...
            <p className="text-gray-600 mb-6">
              Please login to create and publish blog posts.
            </p>
            <button
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white border-2 border-[#295557] rounded-lg p-6">
                  ...
                  <p className="text-gray-600 text-sm mb-6">
                    Ready to share your blog post with the world?
                  </p>
      ...
      >
        <div className="py-4">
          ...
          <p className="text-sm text-gray-500 mt-2">
            This category will be added locally and sent with your blog post.
          </p>
        </div>
      </Modal>
