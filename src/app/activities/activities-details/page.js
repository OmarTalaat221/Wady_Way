...
const Page = () => {
  ...
  const images = [
    {
      id: 1,
      imageBig: "https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920955/francisco-jesus-navarro-hernandez-dtCTfjTEOgg-unsplash_etmisa.jpg",
    },
    {
      id: 2,
      imageBig: "https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920941/backroad-packers-BxxRsrp7nzA-unsplash_yeixwu.jpg",
    },
    {
      id: 3,
      imageBig: "https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920837/mathieu-chirico-sFSZuKI2CvY-unsplash_aygapo.jpg",
    },
    {
      id: 4,
      imageBig: "https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920653/kelly-sikkema-0SYAZsa1Hgo-unsplash_jrtmnq.jpg",
    },
    {
      id: 5,
      imageBig: "https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920602/patrick-untersee--VcD7IYoF14-unsplash_qyei6y.jpg",
    },
    {
      id: 6,
      imageBig: "https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920576/simon-billy-qYZCU9_ITDY-unsplash_bembbg.jpg",
    },
  ];
  return (
    <>
              ...
              <div className="row align-items-center g-3">
                <div className="col-lg-6">
                  <div className="gallery-img-wrap">
                    <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920576/simon-billy-qYZCU9_ITDY-unsplash_bembbg.jpg" alt="" />
                ...
                <div className="col-lg-6 h-100">
                  <div className="row g-3 h-100">
                    <div className="col-6">
                      <div className="gallery-img-wrap">
                        <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920604/juliette-g-bmBLu_oAEj8-unsplash_ake8kg.jpg" alt="" />
                        <a ><i className="bi bi-eye " onClick={() =>setOpenimg({ openingState: true, openingIndex: 1 }) } /></a>
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="gallery-img-wrap">
                        <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920760/kamil-pietrzak-G0FsO2Ca8nQ-unsplash_t1tbz7.jpg" alt="" />
                        <a><i className="bi bi-eye" onClick={() =>setOpenimg({ openingState: true, openingIndex: 2 }) } /></a>
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="gallery-img-wrap active">
                        <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920653/kelly-sikkema-0SYAZsa1Hgo-unsplash_jrtmnq.jpg" alt="" />
                    ...
                    <div className="col-6">
                      <div className="gallery-img-wrap active">
                        <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920602/patrick-untersee--VcD7IYoF14-unsplash_qyei6y.jpg" alt="" />
        ...
        <div className="row g-xl-4 gy-5">
              ...
              <div className="review-area">
                <ul className="comment">
                  <li>
                    <div className="single-comment-area">
                      <div className="author-img">
                        <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740905832/joes-valentine-qyQJU0zKiXk-unsplash_p28qom.jpg" alt="" />
                      </div>
                    ...
                    <ul className="comment-replay">
                      <li>
                        <div className="single-comment-area">
                          <div className="author-img">
                            <img src="https://travelami.templaza.net/wp-content/uploads/2025/02/co-founder1-500x500.jpg" alt="" />
                          </div>
                          <div className="comment-content">
                            <div className="author-name-deg">
                  ...
                  <li>
                    <div className="single-comment-area">
                      <div className="author-img">
                        <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740905588/erik-lucatero-d2MSDujJl2g-unsplash_bukkgc.jpg" alt="" />
                      </div>
                      <div className="comment-content">
                        <div className="author-name-deg">
                  ...
                  <li>
                    <div className="single-comment-area">
                      <div className="author-img">
                        <img src="https://travelami.templaza.net/wp-content/uploads/2025/02/co-founder2.jpg" alt="" />
                      </div>
                      <div className="comment-content">
                        <div className="author-name-deg">
                          <h6>Mr. Bowmik Haldar,</h6>
          ...
          <div className="col-xl-4">
            ...
            <div className="banner2-card">
              <img src="https://res.cloudinary.com/dbz6ebekj/image/upload/v1740920586/mushroom-sorting-office-r14a9t6DSy4-unsplash_pgakqw.jpg" alt="" />
                ...
                <div className="banner2-content">
                  <div className="hotline-area">
                    ...
                    <div className="content">
                      ...
                      <h6><a href="tel:+968737621432">+968-737 621 432</a></h6>
                    </div>
                  </div>
                </div>
              </div>
