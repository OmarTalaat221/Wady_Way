...
const PackageInfo = ({ tourData }) => {
  ...
  const getDescription = () => {
    if (!tourData.description) return t("noDescription");

    if (typeof tourData.description === "string") {
      return tourData.description;
    }
      ...
      {/* <div className="price-info">
        <div className="price-display">
          <span className="current-price">
            ...
            {tourData.price_current}
          </span>
          {tourData.price_original &&
            tourData.price_original !== tourData.price_current && (
