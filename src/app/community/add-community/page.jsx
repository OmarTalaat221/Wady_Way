        ...
        const fetchCategories = async () => {
            try {
                ...
                if (response.data.status === "success") {
                    // Transform the response to label/value structure
                                ...
                                <div className="bg-white border border-gray-200 rounded-lg p-6 hover:border-[#e8a355] transition-colors duration-300">
                                    ...
                                    <div className="flex mb-4 bg-gray-100 rounded-lg p-1">
                                        <button
                                            ...
                                            className={`flex-1 py-2 px-3 rounded-tl-md rounded-bl-md text-sm font-medium transition-colors duration-300 flex items-center justify-center space-x-2 ${imageInputMode === "upload"
                                        ...
                                        <button
                                            ...
                                            className={`flex-1 py-2 px-3 rounded-tr-md rounded-br-md text-sm font-medium transition-colors duration-300 flex items-center justify-center space-x-2 ${imageInputMode === "url"
                                                ? "bg-[#295557] text-white"
                                                : "text-gray-600 hover:text-[#295557]"
                                                }`}
                                        >
