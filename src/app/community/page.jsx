...
const page = () => {
        ...
        try {
            ...
            if (response.data.status === "success") {
                ...
                const uniqueCategories = [
                    "All",
                    ...new Set(posts.map((blog) => blog.category)),
                ];
                setCategories(uniqueCategories);

                setDisplayBlogs(posts.slice(0, blogsPerPage));
            }
        } catch (error) {
    ...
    return (
        <>
            {/* <Topbar /> */}
            {/* <Header /> */}
            <Breadcrumb pagename="Community Grid" pagetitle="Community Grid" />
                ...
                <div className="container">
                    ...
                    <div className="flex overflow-x-auto pb-2 snap-x no-scroll  flex-wrap justify-center gap-3 mb-16">
                        {categories.map((filter) => (
                            <button
                                ...
                                className={`group/filter snap-center relative px-5 py-2.5 rounded-full font-medium text-sm transition-all duration-300 overflow-hidden ${activeFilter === filter
                    ...
                    <div className="text-center mb-6">
                        <p className="text-gray-600">
                            Showing {displayBlogs.length} of {filteredBlogs.length} posts
                            {activeFilter !== "All" &&
                                ...
                                {displayBlogs.length > 0 ? (
                                            ...
                                            <div key={blog.blog_id} className="col-lg-4 col-md-6">
                                                <div className="blog-card">
                                                    <div className="blog-card-img-wrap">
                                                        ...
                                                        <Link href="/community" className="date">
                                                            <span>
                                    ...
                                    <div className="col-12">
                                        <div className="text-center py-20">
                                            ...
                                            <h4 className="text-gray-500 mb-2">No posts found</h4>
                                            <p className="text-gray-400">
                                                {activeFilter !== "All"
                                                    ? `No posts found in "${activeFilter}" category. Try selecting "All" or another category.`
                                        ...
                                        <nav className="inner-pagination-area">
                                            <ul className="pagination-list">
                                                ...
                                                <li>
                                                    <button
                                                        ...
                                                        className={`shop-pagi-btn ${currentPage === 1
                                                    ...
                                                    <li key={index}>
                                                        {page === "..." ? (
                                                            ...
                                                            <button
                                                                ...
                                                                className={`px-3 py-2 rounded transition-colors duration-200 ${currentPage === page
                                                ...
                                                <li>
                                                    <button
                                                        ...
                                                        className={`shop-pagi-btn ${currentPage === totalPages
                                                            ? "opacity-50 cursor-not-allowed"
                                                            : "hover:bg-gray-100"
                                                            }`}
                                                    >
                                            ...
                                            <div className="text-center mt-4">
                                                <span className="text-sm text-gray-500">
                                                    ...
                                                    {filteredBlogs.length} total posts)
                                                </span>
                                            </div>
                                        </nav>
                                    </div>
