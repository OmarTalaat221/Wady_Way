...
const Page = () => {
  ...
  const [activeFilter, setActiveFilter] = useState("all"); // Changed to lowercase "all"
  ...
  // ✅ FIXED: Filter posts by category ID
                            ...
                            <div className="blog-card-content-top">
                              <ul>
                                <li>
                                  By{" "}
                                  <Link href="/community">
                                    {blog.user_data?.full_name || "Anonymous"}
                                  </Link>
                                </li>
                                <li>
                                  {/* ✅ FIXED: Use category_name instead of category */}
                                  <Link href="/community">
                  ...
                  <div className="col-12">
                    <div className="text-center py-20">
                      ...
                      <p className="text-gray-400">
                        {activeFilter !== "all" && getActiveCategoryName()
                          ? `No posts found in "${getActiveCategoryName()}" category. Try selecting "All" or another category.`
