    ...
    <div className="text-center py-20">
      ...
      <p className="text-gray-400">
        {activeFilter !== "all" && activeCategoryName
          ? `No posts found in "${activeCategoryName}" category. Try selecting "All" or another category.`
...
const BlogCard = memo(({ blog }) => {
  ...
  const detailHref = `/community/community-details?community_id=${blog.blog_id}`;
      ...
      <article className="blog-card">
        ...
        <div className="blog-card-content">
          <div className="blog-card-content-top">
            <ul>
              <li>
                By <span>{blog.user_data?.full_name || "Anonymous"}</span>
              </li>
              <li>
...
const CategoryFilterButton = memo(
  ({ categoryId, label, count, isActive, onClick }) => (
    <button
      ...
      aria-label={`Filter by ${label}, ${count} posts`}
    >
...
const Page = () => {
  ...
  // Display blogs (paginated slice of filtered)
    ...
    <>
      ...
      <main className="blod-grid-section pt-[50px] mb-[20px]">
        <div className="container">
          ...
          {/* ── Category Filters — Horizontal Snap Scroll ── */}
