  ...
  const carImages = [
    {
      ...
      alt: "Toyota Corolla Dashboard Interior",
    },
    {
      src: "https://images.pexels.com/photos/1719648/pexels-photo-1719648.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      alt: "SUV Interior Side View",
    },
    {
      src: "https://images.pexels.com/photos/3136673/pexels-photo-3136673.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      alt: "Modern Car Interior Console",
    },
    {
      src: "https://images.pexels.com/photos/1592384/pexels-photo-1592384.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      alt: "SUV Front Exterior View",
    },
  ];
        ...
        <div className="container">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              ...
              <p className="text-base mb-4">{t("description1")}</p>
              <p className="text-base mb-4">{t("description2")}</p>
              <p className="text-base mb-4">{t("description3")}</p>
              ...
              <div className="includ-and-exclud-area mb-[20px]">
                <div className="bg-[#f8f8f8] p-4 rounded-lg mb-4">
                  ...
                  <ul>
                    <li className="mb-2 flex items-start">
                      <i className="bi bi-check-lg text-green-600 mr-2 mt-1" />{" "}
                      {t("included.item1")}
                    </li>
                    <li className="mb-2 flex items-start">
                      <i className="bi bi-check-lg text-green-600 mr-2 mt-1" />{" "}
                ...
                <div className="bg-[#f8f8f8] p-4 rounded-lg">
                  <h5 className="text-lg font-semibold mb-3 text-[#e63946]">
                    {t("excluded.title")}
                  </h5>
                  <ul className="exclud">
                    <li className="mb-2 flex items-start">
                      <i className="bi bi-x-lg text-red-500 mr-2 mt-1" />{" "}
                      {t("excluded.item1")}
                    </li>
                    <li className="mb-2 flex items-start">
                      <i className="bi bi-x-lg text-red-500 mr-2 mt-1" />{" "}
                        ...
                        <form>
                          ...
                          <div className="flex items-center justify-between p-4 mb-6 bg-orange-50 rounded-lg">
                            ...
                            <span className="text-xl font-bold text-[#e8a355]">
                              ${nightCount > 0 ? 200 * nightCount : 200}
                            </span>
                          </div>
